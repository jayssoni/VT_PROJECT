    ...
    <div className='w-[100vw] h-[70px] bg-white/90 backdrop-blur-lg z-50 fixed top-0 flex items-center justify-between px-[30px] shadow-xl border-b border-gray-200/50'>
        ...
        <div className='w-[50%] lg:w-[40%] hidden md:flex'>
            <ul className='flex items-center justify-center gap-[15px]'>
                <li className='text-[18px] font-bold  cursor-pointer hover:bg-gray-100 py-[10px] px-[20px] rounded-xl text-gray-700 hover:text-blue-600 transition-all duration-300' onClick={() => navigate("/")}>HOME</li>
                <li className='text-[18px] font-bold  cursor-pointer hover:bg-gray-100 py-[10px] px-[20px] rounded-xl text-gray-700 hover:text-blue-600 transition-all duration-300' onClick={() => navigate("/collection")}>COLLECTIONS</li>
                <li className='text-[18px] font-bold  cursor-pointer hover:bg-gray-100 py-[10px] px-[20px] rounded-xl text-gray-700 hover:text-blue-600 transition-all duration-300' onClick={() => navigate("/about")}>ABOUT</li>
                <li className='text-[18px] font-bold  cursor-pointer hover:bg-gray-100 py-[10px] px-[20px] rounded-xl text-gray-700 hover:text-blue-600 transition-all duration-300' onClick={() => navigate("/contact")}>CONTACT</li>
            </ul>
        </div>
                    ...
                    <div className='absolute right-0 top-[45px] w-[200px] bg-white rounded-2xl shadow-xl border border-gray-200/50 py-[10px] z-50'>
                        {userData ? (
                            <>
                                ...
                                <div className='px-[20px] py-[8px] hover:bg-gray-50 cursor-pointer text-[14px] text-gray-700' onClick={() => {navigate("/profile"); setShowProfile(false)}}>My Profile</div>
                                <div className='px-[20px] py-[8px] hover:bg-gray-50 cursor-pointer text-[14px] text-gray-700' onClick={() => {navigate("/orders"); setShowProfile(false)}}>My Orders</div>
                                <div className='px-[20px] py-[8px] hover:bg-gray-50 cursor-pointer text-[14px] text-red-600' onClick={() => {handleLogout(); setShowProfile(false)}}>Logout</div>
                            </>
                        ) : (
                            <div className='px-[20px] py-[8px] hover:bg-gray-50 cursor-pointer text-[14px] text-gray-700' onClick={() => {navigate("/login"); setShowProfile(false)}}>Login</div>
                        )}
                    </div>
                )}
            </div>
        ...
        <div className='md:hidden absolute top-[70px] left-0 w-full bg-white/95 backdrop-blur-lg shadow-xl border-b border-gray-200/50 py-[20px] px-[30px] z-40'>
            <ul className='flex flex-col gap-[15px]'>
                <li className='flex items-center gap-[10px] text-[16px] font-medium cursor-pointer py-[12px] px-[20px] rounded-2xl hover:bg-gray-100 text-gray-700 hover:text-blue-600 transition-all duration-300' onClick={() => navigate("/")}>
                    <IoMdHome className='text-[20px]' /> HOME
                </li>
                <li className='flex items-center gap-[10px] text-[16px] font-medium cursor-pointer py-[12px] px-[20px] rounded-2xl hover:bg-gray-100 text-gray-700 hover:text-blue-600 transition-all duration-300' onClick={() => navigate("/collection")}>
                    <HiOutlineCollection className='text-[20px]' /> COLLECTIONS
                </li>
                <li className='flex items-center gap-[10px] text-[16px] font-medium cursor-pointer py-[12px] px-[20px] rounded-2xl hover:bg-gray-100 text-gray-700 hover:text-blue-600 transition-all duration-300' onClick={() => navigate("/about")}>
                    <FaCircleUser className='text-[20px]' /> ABOUT
                </li>
                <li className='flex items-center gap-[10px] text-[16px] font-medium cursor-pointer py-[12px] px-[20px] rounded-2xl hover:bg-gray-100 text-gray-700 hover:text-blue-600 transition-all duration-300' onClick={() => navigate("/contact")}>
                    <MdContacts className='text-[20px]' /> CONTACT
                </li>
            </ul>
        </div>
    </div>
